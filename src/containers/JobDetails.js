...
class JobDetails extends Component {
  ...
  handleAddApplicant = () => {
    ...
    this.props.actions.addApplicant(job.id, applicant).then(a => {
      this.handleAddApplicantsClickClose();
    });
  };
    ...
    return (
      <div>
        ...
        >
          ...
          <DialogActions>
            <Button
              onClick={this.handleAddApplicantsClickClose}
              color="primary"
            >
              Cancel
            </Button>
        ...
        >
          ...
          <DialogContent>
            ...
            >
              {potentialInterviewers.map(user => (
                <MenuItem key={user.name} value={user.userid}>
                  {user.name}
                </MenuItem>
              ))}
            </Select>
          ...
          <DialogActions>
            <Button
              onClick={this.handleAddInterviewerClickClose}
              color="primary"
            >
              Cancel
            </Button>
